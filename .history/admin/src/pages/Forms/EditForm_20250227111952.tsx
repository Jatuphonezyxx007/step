...
export default function EditForm() {
  ...
  // รวมภาพทั้งหมด (ภาพหลัก + ภาพรอง)
  // ใส่ mainImageUrl เป็นตัวแรก จากนั้นตามด้วย supplementaryImages
      ...
      <div className="grid grid-cols-1 gap-6 xl:grid-cols-2">
        <div className="space-y-6">
          <ComponentCard title="รูปภาพสินค้า">
            <ThreeColumnImageGrid
              images={allImages}
              onAddClick={handleAddImage} // ถ้าไม่ต้องการ Event ก็ลบ prop นี้ได้
            />
            <FileInput />
          </ComponentCard>
        </div>
