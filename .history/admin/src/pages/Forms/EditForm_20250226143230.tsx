...
//     email: product.email, 
//     categoryId: product.category_id  // สมมุติว่า product.category_id มีค่า
//   }}
//   categories={fetchedCategories}  // fetchedCategories เป็น array ของ { value, label } ที่ดึงมาจาก API ของ categories
// />
      ...
      <div className="grid grid-cols-1 gap-6 xl:grid-cols-2">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <DefaultInputs 
            initialValues={{ 
              productName: product.product_name, 
              email: product.email,  // ถ้ามี field email
