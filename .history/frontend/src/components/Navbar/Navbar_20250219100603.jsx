...
import { Bars3Icon, MagnifyingGlassIcon, UserCircleIcon, XMarkIcon } from '@heroicons/react/24/outline';
import logo from '../../assets/logo/step-solutions-logo.png';
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center h-20">
        <div className="flex items-center">
          ...
          <button className="hidden md:flex bg-gray-100 hover:bg-gray-200 px-4 py-2 rounded-lg items-center gap-2 transition-all">
      ...
      {isMobileMenuOpen && (
        ...
        >
          ...
          />
          <Link to="/" className="block text-lg font-medium text-gray-700 hover:text-blue-600 transition-all">
            หน้าแรก
          </Link>
          <Link to="/computers" className="block text-lg font-medium text-gray-700 hover:text-blue-600 transition-all">
            คอมพิวเตอร์เซ็ต
          </Link>
          <Link to="/accessories" className="block text-lg font-medium text-gray-700 hover:text-blue-600 transition-all">
            อุปกรณ์คอม
          </Link>
          <Link to="/blog" className="block text-lg font-medium text-gray-700 hover:text-blue-600 transition-all">
            บทความ
          </Link>
          <Link to="/contact" className="block text-lg font-medium text-gray-700 hover:text-blue-600 transition-all">
            ติดต่อเรา
          </Link>
