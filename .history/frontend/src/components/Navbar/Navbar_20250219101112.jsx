    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center h-20">
        <div className="flex items-center gap-2">
          ...
          <button
            className="bg-gray-100 hover:bg-gray-200 px-3 py-2 rounded-lg flex items-center gap-2 transition-all"
      ...
      {isMobileMenuOpen && (
        ...
        >
          <div className="flex justify-between items-center border-b pb-2">
            <h2 className="text-lg font-semibold text-gray-700">หมวดหมู่สินค้า</h2>
            <button
          ...
          <ul className="space-y-3">
            {categories.map((category, index) => (
              <li
                key={index}
                className="flex justify-between items-center text-gray-700 text-md font-medium hover:text-blue-600 cursor-pointer"
              >
                {category}
          ...
          <div className="border-t pt-4 flex justify-center">
            <motion.div
              className="bg-gray-100 rounded-full p-3 cursor-pointer hover:bg-gray-200"
              whileHover={{ scale: 1.1 }}
            >
              <UserCircleIcon className="h-8 w-8 text-gray-700" />
            </motion.div>
